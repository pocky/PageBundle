...
class CreateWebPageTransformerSpec extends ObjectBehavior
{
    ...
    function let()
    {
        ...
        $this->dtoClass    = 'Black\Bundle\PageBundle\Application\DTO\CreateWebPageDTO';
    ...
    {
        $this->shouldHaveType('Black\Bundle\PageBundle\Application\DTO\CreateWebPageTransformer');
    }
